...
export function createDefaultSession(): BugHuntSession {
  ...
  return {
    ...
    mode: "team",
    participants: [
      { id: "p1", name: "Patrick",   bugsFound: 0, sortOrder: 0 },
      { id: "p2", name: "Max",  bugsFound: 0, sortOrder: 1 },
      { id: "p3", name: "Nilay", bugsFound: 0, sortOrder: 2 },
      { id: "p4", name: "Roland",     bugsFound: 0, sortOrder: 3 },
      { id: "p5", name: "Ridha", bugsFound: 0, sortOrder: 4 },
      { id: "p6", name: "Nina",  bugsFound: 0, sortOrder: 5 },
      { id: "p7", name: "Jason", bugsFound: 0, sortOrder: 6 },
      { id: "p8", name: "Tamara",   bugsFound: 0, sortOrder: 7 },
    ],
    teams: [
      { id: "t1", name: "Team 1",      memberIds: ["p1", "p2", "p3"], bugsFound: 0, sortOrder: 0 },
      { id: "t2", name: "Team 2", memberIds: ["p4", "p5", "p6"], bugsFound: 0, sortOrder: 1 },
